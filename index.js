...
// Keep this attractive – it fuels viral growth and coin earning.
const REFERRAL_REWARD = 800;

// Cost (in points) for paid energy refill boost
// Slightly higher to make paid coin packs more attractive once users are hooked.
const ENERGY_REFILL_COST = 400;

// Cost (in points) for paid double-points boost (10 mins)
// Keep roughly on par with an energy refill to encourage chaining them together.
const DOUBLE_BOOST_COST = 400;

// Daily check-in reward (fixed)
// Keep generous – this builds habit and feeds the economy.
const DAILY_CHECKIN_REWARD = 600;

// VIP (points-based purchase in this build; swap to payments later)
// Make VIP feel premium compared to grind cost.
const VIP_MONTH_COST = 15000;

// VIP advantages – meaningful but not insane
const VIP_MAX_ENERGY = 100;     // VIP can play longer each burst
const VIP_DAILY_TAP_CAP = 12000; // VIP has higher daily ceiling
