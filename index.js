...
function getStreakMetaFromUser(user) {
  ...
  const lastCheckinAt = user.last_checkin_at ? new Date(user.last_checkin_at) : null;
  const lastCheckinDay = lastCheckinAt && !isNaN(lastCheckinAt) ? utcDayString(lastCheckinAt) : null;
