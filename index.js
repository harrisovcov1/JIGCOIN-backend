...
app.post("/api/state", async (req, res) => {
  try {
    ...
    // NOTE: anti-bot / rate limiting must be enforced on write endpoints (e.g. /api/tapPacket),
    // not on /api/state. Otherwise normal UI refreshes can incorrectly trigger bans.
