...
app.post("/api/tap", async (req, res) => {
  try {
    ...
    // 1) New day? reset today_farmed, taps_today, and refill to max
    // NOTE: Energy regeneration is applied in /api/state only to prevent energy increasing mid-tapping.
    user = await ensureDailyReset(user);
