  ...
  try {
    ...
    const insertRes = await client.query(
      `INSERT INTO public.users
        (telegram_id, username, first_name, last_name, balance, early_access_awarded, early_access_rank, early_access_awarded_at)
       VALUES
        ($1, $2, $3, $4, $5, $6, $7, CASE WHEN $6 THEN NOW() ELSE NULL END)
       RETURNING *`,
      [telegramUserId, username, firstName, lastName, starter, earlyEligible, earlyRank]
    );
